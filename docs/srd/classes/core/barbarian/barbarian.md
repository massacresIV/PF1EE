...
<figure className="artworkFigure">
  <img src="/img/artwork/classes/Barbarian.png" alt="Barbarian Class Artwork" />
...
A complete list of rage powers can be found here: [Rage Powers](docs\srd\classes\core-classes\barbarian\rage-powers\rage-powers)
