...
<figure className="artworkFigure">
  <img src="/img/artwork/classes/Druid.png" alt="Druid Class Artwork" />
...
**Prepared Casting:** A Druid must choose and prepare her spells in advance through daily ritual and meditation.

To prepare or cast a spell, the druid must have a Wisdom score equal to at least 10 + the spell level. The Difficulty Class for a saving throw against a druid’s spell is 10 + the spell level + the druid’s Wisdom modifier.

A druid can only cast a limited number of spells per spell level each day, as shown on the class progression table. In addition, she receives bonus spells per day if her Wisdom is high enough (see “Ability Modifiers and Bonus Spells”).
...
## Nature Bond (Ex)
At 1st level, a druid forms a bond with nature. This bond can take one of three forms. First is that of a cleric domain, reflecting a spiritual connection to natural forces. Second is an animal companion, a loyal creature that serves as her ally and protector. Third is Druidic herbalism, the knowledge and practice of crafting potent natural concoctions.

### Animal Companion
A druid who chooses this option begins play with a loyal animal companion drawn from the available choices for druids. This companion advances in Hit Dice, abilities, skills, and feats as the druid gains levels. Most animal companions increase in size when the druid reaches 4th or 7th level, depending on the creature.

If the druid receives an animal companion from multiple sources, her effective druid levels stack when determining the companion’s statistics and abilities.

If she ever releases her companion from service, she may gain a new one by performing a 24-hour ritual of prayer and communion in an environment where the desired animal naturally lives. This same ritual can also replace a deceased companion.

> See: [Animal Companions/Drake Companions] for more information on how animal companions function.

### Cleric Domain
A druid who selects a domain gains access to one cleric domain from the following list: **Air, Animal, Earth, Fire, Plant, Water, or Weather**. In addition, druids have access to a selection of **Animal and Terrain** domains (GM's discretion may apply).
...
- **Additional Concoctions:** Beyond her free concoctions, the druid may craft additional herbal concoctions using the normal rules for the *Brew Potion* feat, including crafting time, cost, and requirements. These additional concoctions are still considered herbal concoctions rather than standard potions.

At 4th level, the druid's skill improves:
- **Deception:** She can disguise a concoction’s appearance and magical aura to resemble another of her concoctions. A creature must exceed the Spellcraft or Perception DC by 5 or more to correctly identify its true effect. The false result must be selected during creation.
- **Efficient Crafting:** The druid crafts additional (paid) concoctions at half the normal gold cost and in half the normal crafting time.
- **Expanded Access:** She can create herbal concoctions using spells from any spell list, as long as she can cast the spell.

At 7th level, her mastery grows:
- **Improved Disguise:** A creature must now exceed the identification DC by 10 or more to discern a disguised concoction’s true nature.
- **Rapid Brewing:** She can create any herbal concoction (free or paid) in 1 minute.
- **Infused Concoctions:** She can craft *infused* concoctions of any spell she can cast of 4th level or higher by expending a spell slot of the same level. These concoctions cost nothing and function like *infused* extracts made by an alchemist.
