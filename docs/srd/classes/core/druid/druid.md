...
A druid can only cast a limited number of spells of each spell level per day, as shown on the class progression table. In addition, she receives bonus spells per day if her Wisdom is high enough (see “Ability Modifiers and Bonus Spells”).
