...
>
  <img
    src={useBaseUrl('/img/artwork/classes/Witch.png')}
    alt="Witch Class Artwork"
    style={{
      height: '550px',
      maxWidth: 'unset',
      width: 'auto',
...
At 1st level, and every two levels thereafter, a witch's patron adds new spells to a witch's list of spells known. These spells are also automatically added to the list of spells stored by the familiar. In addition, a Witch gains one patron spell slot for each level of Witch spell she can cast, from 1st on up. Each day, a Witch can prepare patron spells in that slot. The spells gained depend upon the patron chosen. Each patron is listed by its theme. Its actual name is up to the GM and the witch to decide.

A Witch gains one patron spell slot for each level of Witch spell she can cast, from 1st on up. Each day, a Witch can prepare one of her patron spells in that slot.
