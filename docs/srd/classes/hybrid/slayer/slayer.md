...
>
  <img
    src={useBaseUrl('/img/artwork/classes/Slayer.png')}
    alt="Slayer Class Artwork"
    style={{
      height: '600px',
      maxWidth: 'unset',
      width: 'auto',
...
Deft stalkers of the most dangerous prey, slayers merge the ranger’s combat training with the rogue’s crippling attacks.
