...
import { humanRacialTraits } from "@site/src/data/racial-traits/human-racials";
...
### Focused Human
Focused Humans are skillful, but some, rather than being generalists, tend to specialize in a handful of skills. Focused Humans gain the following racial traits;
- **Focused Study:** Focused-kind gain additional Skill Focus feats at 8th and 16th level. 

### Primitive Human
Primitive Humans devote more of their time to honing the basic skills of how to avoid predators and gather food, rather than to higher-minded pursuits. Primitive Humans gain the following racial traits;
...
### Versatile Human
Versatile Human's adaptability and versatility allows them to pursue almost any calling with a surprising level of competence. Versatile Humans gain the following racial traits;
