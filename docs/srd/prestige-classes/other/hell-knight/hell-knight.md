...
>
  <img
    src="/PF1EE/img/artwork/prestige-classes/Hellknight.png"
...
<table class="classTable">
    ...
    <tbody>
        <tr><td>1st</td><td>+1</td><td>+2</td><td>+0</td><td>+2</td><td>Aura of Law, Detect Chaos, Hellknight Order, Smite 1/day</td></tr>
        <tr><td>2nd</td><td>+2</td><td>+3</td><td>+0</td><td>+3</td><td>Discern Lies, Hellknight Armor Training</td></tr>
        <tr><td>3rd</td><td>+3</td><td>+3</td><td>+1</td><td>+3</td><td>Discipline</td></tr>
        <tr><td>4th</td><td>+4</td><td>+4</td><td>+1</td><td>+4</td><td>Smite 2/day</td></tr>
        <tr><td>5th</td><td>+5</td><td>+4</td><td>+1</td><td>+4</td><td>Lawbringer</td></tr>
        <tr><td>6th</td><td>+6</td><td>+5</td><td>+2</td><td>+5</td><td>Discipline, Hellknight Armor Training</td></tr>
        <tr><td>7th</td><td>+7</td><td>+5</td><td>+2</td><td>+5</td><td>Smite 3/day</td></tr>
        <tr><td>8th</td><td>+8</td><td>+6</td><td>+2</td><td>+6</td><td>Infernal Armor</td></tr>
        <tr><td>9th</td><td>+9</td><td>+6</td><td>+3</td><td>+6</td><td>Discipline</td></tr>
        <tr><td>10th</td><td>+10</td><td>+7</td><td>+3</td><td>+7</td><td>Hellknight Armor Training, Smite 4/day</td></tr>
        <tr><td>11th</td><td>+11</td><td>+7</td><td>+3</td><td>+7</td><td>Infernal Armament</td></tr>
        <tr><td>12th</td><td>+12</td><td>+8</td><td>+4</td><td>+8</td><td>Discipline</td></tr>
        <tr><td>13th</td><td>+13</td><td>+8</td><td>+4</td><td>+8</td><td>Smite 5/day</td></tr>
        <tr><td>14th</td><td>+14</td><td>+9</td><td>+4</td><td>+9</td><td>Hellknight Armor Mastery</td></tr>
        <tr><td>15th</td><td>+15</td><td>+9</td><td>+5</td><td>+9</td><td>Discipline, Hell's Knight</td></tr>
    </tbody>
</table>

:::info[Changes]
Removed Force of Will class feature. Improved Will save progression.
:::

# Class Features

## Smite (Su)
At 1st level, a Hellknight gains the ability to focus her wrath against those who oppose her order. As a swift action, the Hellknight chooses one target within sight to smite. While smiting, the Hellknight gains bonuses against the target and may deal additional damage on attacks made against that foe.

If the Hellknight already possesses the Smite ability from another class or the Challenge ability, her Hellknight levels stack with those classes to determine the damage bonus and number of uses per day. When the Hellknight elects to smite a target and has access to multiple smite types, she must choose which type of smite she is using (for example, Smite Chaos or Smite Evil) when the ability is activated. A single use of a smite cannot apply to more than one type, and the Hellknight cannot have more than one smite or challenge active at the same time. All Smite and Challenge abilities draw from a shared pool of daily uses, though each must be declared and resolved according to its own rules when activated.

:::info[Changes]
Added stacking with Smite & Challenge class features.
:::

### Smite Chaos (Su)
- If the target of a Smite Chaos is chaotic-aligned, the Hellknight adds her Charisma bonus (if any) to her attack rolls and her Hellknight level to all damage rolls against the target.

- If the target is an outsider with the chaotic subtype, a chaotic-aligned aberration, or a fey, the damage bonus on the first successful attack increases to 2 points of damage per Hellknight level.

- All attacks against the target automatically bypass any damage reduction the creature might possess.

- While the smite is active, the Hellknight gains a deflection bonus to AC equal to her Charisma modifier against attacks made by the target.

- The smite effect remains until the target is dead or the Hellknight rests and regains the use of this ability.

- If the target is not affected by the chosen smite type, the smite has no effect, but is still expended for the day.
...
**Advanced Armor Training:** A Hellknight may select an advanced armor training option (see Advanced Armor Training below) in place of increasing the benefits of her Hellknight Armor Training. For the purpose of qualifying for advanced armor training, a Hellknight counts her levels in this class together with any levels in another class that grants the Armor Training ability. She qualifies for advanced armor training beginning at the level at which her combined levels meet the normal prerequisites (6th level for Hellknight levels alone), or earlier if her combined levels from multiple classes reach the requirement.

:::info[Changes]
Added stacking with Armor Training class feature. 
:::

## Disciplines (Ex)
At 3rd level, a Hellknight gains her first discipline, choosing one associated with her specific order.  

At 6th level, she gains a second discipline, choosing from any discipline listed as available to “any order.”  

At 9th level and every three levels thereafter (12th and 15th), the Hellknight gains an additional discipline, choosing from any discipline listed below, including those normally associated with other orders.  

When applicable, the save DC to resist a discipline’s effect is equal to 10 + the Hellknight’s level + her Charisma modifier.

:::info[Changes]
Moved uses per day limitations to specific disciplines for use clarification. Removed Pentamic Faith restriction exception.
:::
...
- **Versatile Intimidation (Ex):** The Hellknight can use Intimidate to reproduce the effects of another Charisma-based skill. Choose one of the following: Bluff, Diplomacy, Handle Animal, or Perform (oratory). Each time the Hellknight wishes to use that skill, she can attempt an Intimidate check and treat it as if it were a check of the desired type. At 9th level, and again at 15th level, the Hellknight can choose an additional skill from the list above and use Intimidate to reproduce its effects.

:::info[Changes]
No longer limited per day. Added an additional skill at 15th.
:::

- **Wrack (Su):** The Hellknight may make a touch attack as a standard action to cause a creature to suffer incredible pain. The creature touched takes 1d6 points of damage + the Hellknight’s Charisma modifier, and must make a Will save to avoid being staggered for 1d4 rounds.
...
### Order of the Scourge Disciplines
These disciplines may be selected by a Hellknight belonging to the Order of the Scourge;

- **Vigilance (Su):** The Hellknight gains low-light vision (this effect is constant). In addition, as a full-round action, the Hellknight can see through up to 5 feet of stone, wood, or similar barriers as if they didn’t exist. Metal or denser barriers block this effect. Each use of this ability lasts as long as the Hellknight concentrates, up to a number of rounds equal to the Hellknight’s level. The Hellknight can use this discipline a number of times per day equal to the total number of disciplines she possesses.

### Order of the Torrent Disciplines
These disciplines may be selected by a Hellknight belonging to the Order of the Torrent;

- **Seek the Taken:** The Hellknight can use enlarged *locate creature* as a spell-like ability, as if the Enlarge Spell metamagic feat were applied to the spell, using her character level as her caster level. The Hellknight can use this discipline a number of times per day equal to the total number of disciplines she possesses. A Hellknight of the Order of the Torrent cannot select the *Summon Devil* discipline when choosing disciplines from another order (i.e., the additional disciplines gained at 9th level and beyond).
...
## Infernal Armament (Su)
At 11th level, a Hellknight can grant a weapon she wields or touches the axiomatic, flaming, or unholy special ability. The weapon retains this ability as long as the Hellknight remains within 100 feet of it. She may affect only one weapon at a time.

:::info[Changes]
Split from the Hell's Knight capstone ability.
:::
...
## Hell’s Knight (Su)
At 15th level, a Hellknight becomes a flawless instrument of order, her mortal weaknesses burned away in the fires of discipline.

While wearing Hellknight plate, she gains immunity to fire, fear, and compulsion effects.

Whenever she successfully strikes the target of her Smite Chaos, that creature must succeed at a Will save (DC 10 + 1/2 the Hellknight’s class level + her Charisma modifier) or be affected as though by dimensional anchor for 1 minute. If the target is a chaotic outsider, it instead must succeed at this save or be affected as though by banishment, using the Hellknight’s class level as the caster level. After the banishment effect and the damage from the attack is resolved, the Smite immediately ends.

:::info[Changes]
Updated capstone ability. Added immunity to fear and compulsion effects. Added dimensional anchor / banishment to Smite Chaos, to match Champion's capstone. 
:::