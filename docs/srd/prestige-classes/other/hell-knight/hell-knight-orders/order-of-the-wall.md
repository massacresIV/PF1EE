...
**Leader:** Master of Blades Atlan Essebar
...
## Reckoning 
Repeatedly strike bricks or stone. Gain a +4 bonus on Fortitude saving throws to resist poison. This increases to +6 against ingested poisons.
...
### 3: Ruin (Sp)
Once per day as a standard action, you can use *greater shout* as a spell-like ability (DC = 18 + your Charisma modifier).
