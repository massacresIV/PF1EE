...
>
  <img
    ...
    alt="Agent of the Grave Prestige Class Artwork"
    style={{
      height: '550px',
      maxWidth: 'unset',
      width: 'auto',
...
**Special:** Must be aware of the Whispering Way and their practices.
...
Agents of the grave gain no proficiency with any weapons or armor.

## Prestigious Spellcasting
When an agent of the grave gains a level, he advances his spellcasting as if he had also gained a level in one spellcasting class he belonged to before adding the prestige class. If he has more than one spellcasting class before becoming an agent of the grave, he must decide which spellcasting class to advance for the purpose of determining spells per day. 

This advancement applies to all spellcasting-related benefits of the chosen class, including spells per day, spells known (if he is a spontaneous caster), caster level, and automatic spell acquisition features tied to class level (such as a wizard’s new spells added to his spellbook or a witch’s familiar gaining spells). He does not, however, gain other class features unrelated to spellcasting (such as bonus feats, wild shape, or bardic performance) unless explicitly stated by this prestige class.

:::info[Changes]
Now allows automatic spell acquisition for prepared spellcasters that learn spells each level.
:::
...
## Unholy Fortitude (Su)
At 1st level, the agent of the grave can tap into his conviction and bolster his health. When calculating hit points gained from class levels, he uses his Charisma modifier instead of his Constitution modifier. This benefit applies retroactively to all of his previous class levels.

At 3rd level, the agent of the grave may also use his Charisma modifier in place of his Constitution modifier when making Fortitude saving throws.


:::info[Changes]
Now retroactively uses Charisma for hit points. Added Charisma to Fortitude saving throws in place of Constitution at 3rd level.
:::
...
At 4th level, the agent of the grave, while still technically alive, reacts to positive and negative energy as if he were undead—positive energy harms him, while negative energy heals him. 

If the agent of the grave is already undead or already possesses a form of negative energy affinity (such as a dhampir), this ability instead grants channel resistance +2, or increases any existing channel resistance by 2.

:::info[Changes]
Added redundancy to increase channel energy resistance by 2.
:::
...
## Undeath Initiate (Ex)
At 5th level, an agent of the grave has prepared his body and mind for the transition into undeath. He gains a +5 bonus on any ability check, skill check, or saving throw related to the process of transforming into an undead creature. This bonus can be used on any check related to becoming a creature like a lich (the process of which is largely left up to the GM’s discretion). 

Additionally, the agent of the grave gains a +2 bonus on opposed Charisma checks made against undead already under the control of another creature (such as when issuing conflicting commands with the command undead spell). 

Finally, if slain by an undead creature with the create spawn ability, the agent of the grave retains his Intelligence (regardless of the type of undead he is transformed into) and free will (he is never under the control of the creature that killed him). Unless otherwise noted by the undead creature’s create spawn ability, the newly created undead agent of the grave loses all of his class levels. This makes transformation into a lich and vampire among the most appealing options for an agent of the grave seeking undeath.

:::info[Changes]
Added a +2 bonus on opposed Charisma checks to influence controlled undead.
:::